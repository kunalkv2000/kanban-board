        ...
        <div class="w-full flex flex-col lg:flex-row">
          ...
          >
            <div class="flex lg:items-center justify-start flex-col lg:flex-row max-lg:gap-4 lg:flex-1 lg:justify-end">
              ...
              <Link to="/Projects">
                <button class=" bg-indigo-50 text-indigo-600 py-3 px-6 lg:ml-5 rounded-full cursor-pointer font-semibold text-center shadow-xs transition-all duration-500text-sm hover:bg-indigo-100">
                  Projects
                </button>
              </Link>
              <button
